...
const services = [
  { icon: "Zap", title: "Аварийное вскрытие замков", desc: "Вскроем любой замок без повреждений. Квартира, офис, автомобиль.", price: "от 1 500 ₽" },
  { icon: "Droplets", title: "Устранение протечек", desc: "Ликвидация аварий водоснабжения и канализации в любое время суток.", price: "от 2 000 ₽" },
  { icon: "Flame", title: "Аварийный газ", desc: "Устранение утечек газа, опломбировка, восстановление подачи.", price: "от 2 500 ₽" },
  { icon: "Lightbulb", title: "Аварийная электрика", desc: "Восстановление электроснабжения, замена пробок, автоматов.", price: "от 1 800 ₽" },
  { icon: "Wrench", title: "Сантехника", desc: "Замена труб, устранение засоров, ремонт смесителей и кранов.", price: "от 1 200 ₽" },
  { icon: "Shield", title: "Охрана и безопасность", desc: "Установка замков, укрепление дверей, замена сердцевин.", price: "от 1 500 ₽" },
];
