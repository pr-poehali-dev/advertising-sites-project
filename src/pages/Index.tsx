...
const services = [
  ...
  { icon: "ClipboardList", title: "Вызов аварийного комиссара", desc: "Выезд комиссара на место ДТП или аварии, оформление документов, помощь в общении со страховой.", price: "от 1 000 ₽" },
];
